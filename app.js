...
let aouthor = document.querySelector("#author");
let quotee = document.querySelector("#quote");
document.querySelector("#generate").addEventListener("click", () => {
    setBackGround();
    generate();
})

let randomNumber = () => Math.floor(Math.random() * hexColorNum.length);
let randomColor = () => {
    let colorPart;
    let num;
    let color = "#";
